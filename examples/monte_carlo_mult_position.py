...
MU = 0.00005
SIGMA = [0.07,0.007]
params = list(itertools.product(TIME, SIGMA))
print(params)
for time,sigma in params:
    print(time,sigma)
    ...
    axes[0].set_title('Impermanent Loss Distribution', fontsize=16)
    axes[0].set_xlabel('Loss', fontsize=16)
    ...
    axes[1].set_title('Fees Distribution', fontsize=16)
    axes[1].set_xlabel('Fees Collected', fontsize=16)
    ...
    axes.set_title('Total Return Distribution', fontsize=16)
    axes.set_xlabel('Total Return', fontsize=16)
